...
WRconnection = (
    f'DRIVER=ODBC Driver 18 for SQL Server;SERVER={server};DATABASE={WRatabase};UID={username};PWD={password};TrustServerCertificate=yes;Encrypt=no;Connection Timeout=30;')
