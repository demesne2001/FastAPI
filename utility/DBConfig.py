...
jconnection = (
    f'DRIVER=SQL Server;SERVER={WRserver};DATABASE={WRatabase};UID={WRsername};PWD={WRassword};TrustServerCertificate=yes;Encrypt=no;Connection Timeout=30;')
...
def ExecuteAddEdit(input,spname,MethodNname):    
    param=""
    param=spParam(input)    
    ID=0
    drivers = [item for item in pyodbc.drivers()]    
